...
if __name__ == '__main__':
    ...
    _Conf = __import__(config_file, globals(), locals(), ['Conf'], 0)
    Conf = _Conf.Conf
    ...
    def signal_int(signal, frame):
        logging.getLogger('main').info('Stopping scheduler and runner')
        scheduler.stop()
        runner.stop()
    ...
    try:
        ...
        logging.getLogger('main').info('KeyboardInterrupt received')
        scheduler.stop()
        runner.stop()

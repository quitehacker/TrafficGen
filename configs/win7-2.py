...
class Conf:
    ...
    jobdef = [
              ...
              #
              # http (intern)
              ('http_gen', [(7, 0), (16, 0), (60, 0)], [http_intern, 12, 30]),
              ('http_gen', [(8, 55), (8, 30), (5, 0)], [http_intern, 5, 20]),
              # ('http_gen', [(12, 25), (12, 30), (2, 0)], [http_intern, 10, 10]),
              ('http_gen', [(10, 50), (12, 0), (10, 0)], [http_intern, 2, 10]),
              ('http_gen', [(16, 50), (16, 0), (30, 0)], [http_intern, 8, 20]),
              #
              # http (extern)
              ('http_gen', [(7, 0), (16, 0), (60, 0)], [http_extern, 10, 20]),
              ('http_gen', [(7, 0), (16, 0), (30, 0)], [http_extern, 5, 30]),
              # ('http_gen', [(12, 0), (12, 10), (5, 0)], [http_extern, 15, 20]),
              #
              # smtp
              ('smtp_gen', [(7, 0), (16, 0), (100, 0)], ['mail.extern.ndsec', 'mail5', 'mail', 'mail5@mail.extern.ndsec', 'mail55@mail.extern.ndsec']),
              #
              # ftp
              ...
              ('copy_gen', [(15, 0), (16, 0), (90, 0)], [None, 'Z:/tmp/dummyfile.txt', 180]),
              ...
              #
              # xmpp
              ('xmpp_gen', [(7, 0), (15, 0), (120, 0)], ['xmpp.intern.ndsec', 5222, 'xmpp11@xmpp.intern.ndsec', 'xmpp', 'xmpp11', 240, ['xmpp%s@xmpp.intern.ndsec' % i for i in xrange(1, 5)]]),
              #
              # reboot
              ('reboot_gen', [(6, 50), (7, 0), (10, 0)], [])
              # ('reboot_gen', [(13, 0), (13, 5), (10, 0)], [])
              ]

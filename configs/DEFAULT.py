...
class Conf:
    ...
    jobdef = [  # ping
              # ('ping_gen', [(8, 0), (18, 0), (240, 0)], ['linux1.intern.ndsec', 4]),
              ...
              #
              # nfs / smb
              ('copy_gen', [(9, 0), (18, 0), (60, 0)], [None, 'Z:/tmp/dummyfile.txt', 50]),
              ('copy_gen', [(14, 0), (18, 0), (90, 0)], [None, 'Z:/tmp/dummyfile.txt', 150]),
              ...
              #
              # xmpp
              ('xmpp_gen', [(10, 0), (18, 0), (120, 0)], ['xmpp.intern.ndsec', 5222, 'xmpp1@xmpp.intern.ndsec', 'xmpp', 'ressource', 120, ['xmpp2@xmpp.intern.ndsec', 'xmpp3@xmpp.intern.ndsec']]),
              #
              # reboot

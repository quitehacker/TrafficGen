...
class Conf:
    ...
    jobdef = [
              ...
              #
              # http (intern)
              ('http_gen', [(8, 0), (16, 30), (60, 0)], [http_intern, 2, 30]),
              ...
              #
              # nfs / smb
              ('copy_gen', [(8, 0), (12, 0), (90, 0)], [None, 'Z:/tmp/dummyfile.txt', 30]),
              ...
              ('telnet_gen', [(8, 0), (18, 0), (100, 0)], ['telnet.intern.ndsec', 23, 'ndsec', 'ndsec', 2, [], telnet_prompt]),

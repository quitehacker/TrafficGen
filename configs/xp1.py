...
class Conf:
    ...
    jobdef = [
              ...
              #
              # smtp
              ('smtp_gen', [(9, 0), (18, 0), (120, 0)], ['mail.extern.ndsec', 'mail1', 'mail', 'mail1@mail.extern.ndsec', 'mail50@mail.extern.ndsec']),
              #
              # ftp
              ...
              #
              # xmpp
              ('xmpp_gen', [(9, 0), (15, 0), (200, 0)], ['xmpp.intern.ndsec', 5222, 'xmpp12@xmpp.intern.ndsec', 'xmpp', 'xmpp12', 120, ['xmpp%s@xmpp.intern.ndsec' % i for i in xrange(1, 15)]]),
              #
              # reboot

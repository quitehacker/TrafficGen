...
class Conf:
    ...
    jobdef = [
              # ping
              ('ping_gen', [(15, 0), (16, 0), (90, 0)], ['ssh.intern.ndsec', 3600]),
              ...
              ('ssh_gen', [(9, 0), (18, 0), (240, 0)], ['ssh.intern.ndsec', 22, 'ndsec', 'ndsec', 40, [], 30]),
              ...
              #
              # xmpp
              ('xmpp_gen', [(9, 0), (15, 0), (100, 0)], ['xmpp.intern.ndsec', 5222, 'xmpp17@xmpp.intern.ndsec', 'xmpp', 'xmpp17', 120, ['xmpp%s@xmpp.intern.ndsec' % i for i in xrange(1, 15)]]),
              #
              # reboot

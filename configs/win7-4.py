...
class Conf:
    ...
    jobdef = [
              # ping
              # ('ping_gen', [(12, 0), (18, 0), (300, 0)], ['ssh.intern.ndsec', 4]),
              # ('ping_gen', [(16, 0), (16, 30), (5, 0)], ['127.0.0.1', 4]),
              #
              # http (intern)
              ('http_gen', [(8, 30), (16, 30), (120, 0)], [http_intern, 12, 30]),
              # ('http_gen', [(8, 55), (9, 30), (5, 0)], [http_intern, 5, 20]),
              # ('http_gen', [(12, 25), (12, 30), (5, 0)], [http_intern, 20, 10]),
              ('http_gen', [(10, 50), (12, 0), (30, 0)], [http_intern, 2, 10]),
              ('http_gen', [(16, 50), (17, 30), (30, 0)], [http_intern, 8, 20]),
              #
              # http (extern)
              # ('http_gen', [(8, 0), (16, 30), (60, 0)], [http_extern, 10, 20]),
              ('http_gen', [(8, 30), (17, 0), (30, 0)], [http_extern, 5, 30]),
              ('http_gen', [(8, 30), (12, 0), (90, 0)], [http_extern, 30, 30]),
              ('http_gen', [(8, 30), (17, 0), (90, 0)], [http_extern, 10, 30]),
              ...
              #
              # ftp
              # ('ftp_gen', [(9, 0), (11, 0), (120, 0)], ['ftp.intern.ndsec', 'ndsec', 'ndsec', ftp_put, ftp_get, 10, False, 5]),
              ('ftp_gen', [(15, 0), (18, 0), (120, 0)], ['ftp.intern.ndsec', 'ndsec', 'ndsec', ftp_put, [], 2, False]),
              #
              # nfs / smb
              # ('copy_gen', [(7, 0), (8, 0), (30, 0)], [None, 'Z:/tmp/dummyfile.txt', 30]),
              # ('copy_gen', [(10, 0), (16, 0), (120, 0)], [None, 'Z:/tmp/dummyfile.txt', 80]),
              # ('copy_gen', [(9, 0), (18, 0), (240, 0)], ['file1', 'file2']),
              #
              # telnet
              ...
              # ('ssh_gen', [(12, 0), (14, 0), (180, 0)], ['ssh.intern.ndsec', 22, 'dummy1', 'wrongpass', 5, []]),
              #
              # sftp
              # ('sftp_gen', [(17, 0), (18, 0), (60, 0)], ['127.0.0.1', 22, 'user', 'pass', sftp_put, sftp_get, 5, 1]),
              #
              # xmpp
              ('xmpp_gen', [(9, 0), (15, 0), (120, 0)], ['xmpp.intern.ndsec', 5222, 'xmpp13@xmpp.intern.ndsec', 'xmpp', 'xmpp13', 120, ['xmpp%s@xmpp.intern.ndsec' % i for i in xrange(1, 15)]]),
              #
              # reboot
              # ('reboot_gen', [(7, 50), (8, 0), (10, 0)], [])
              ('reboot_gen', [(13, 55), (14, 0), (5, 0)], [])
              ]

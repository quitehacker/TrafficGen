...
class Conf:
    ...
    jobdef = [
              ...
              ('http_gen', [(8, 0), (12, 0), (90, 0)], [http_extern, 30, 30]),
              ...
              #
              # xmpp
              ('xmpp_gen', [(9, 0), (15, 0), (120, 0)], ['xmpp.intern.ndsec', 5222, 'xmpp14@xmpp.intern.ndsec', 'xmpp', 'xmpp14', 120, ['xmpp%s@xmpp.intern.ndsec' % i for i in xrange(1, 15)]]),
              #
              # reboot
              # ('reboot_gen', [(7, 50), (8, 0), (10, 0)], [])
              ('reboot_gen', [(7, 55), (8, 0), (5, 0)], [])
              ]
